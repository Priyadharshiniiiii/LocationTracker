...
root=Tk()
root.title("Phone Number tacker")
...
def Track():
    ...
    #operator like Idea,airtel,jio,vodafone
...
#icon image
icon=PhotoImage(file="C:\\Users\\priya\\Downloads\\logo image.png")
root.iconphoto(False,icon)

#logo
logo=PhotoImage(file="C:\\Users\\priya\\Downloads\\logo image.png")
Label(root,image=logo).place(x=240,y=70)


Eback=PhotoImage(file="C:\\Users\\priya\\Downloads\\search png.png")
...
#buttom box
Box=PhotoImage(file="C:\\Users\\priya\\Downloads\\bottom png.png")
...
#search button
Search_image=PhotoImage(file="C:\\Users\\priya\\Downloads\\search.png")
